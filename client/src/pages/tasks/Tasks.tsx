...
export default function Tasks() {
  ...
  return <div className="space-y-5">
   <div className="flex flex-wrap items-end justify-between gap-3"><div><h1 className="text-2xl font-semibold">Tasks</h1><p className="text-sm text-slate-500">Search, filter, sort and progressively load tasks.</p></div>{isAdmin && <Link to="/tasks/new" className="rounded-lg bg-indigo-600 px-3 py-2 text-sm font-semibold text-white"><Plus className="mr-1 inline" size={16}/>New Task</Link>}</div>
